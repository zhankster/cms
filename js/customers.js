...
function validateCustomer() {
  ...
  // alert($("#selCountries").val().trim() + " ###Country");
  // alert($("#selState").val().trim() + " ###State");
  // return false;

  if ($("#selCountries").val().trim() == "" || $("#selCountries").val().trim() == "NULL") {
    $("#txtModErr").html("A Country or 'N/A' must be selected");
    $("#modErr").modal();
    $("#selCountries").addClass("err");
    return false;
  }

  if ($("#selState").val().trim() == "" || $("#selState").val().trim() == "NULL") {
    $("#txtModErr").html("A State/Province or 'N/A' must be selected");
    $("#modErr").modal();
    $("#selState").addClass("err");
    return false;
  }
...
$(document).ready(function () {
  ...
  $("#custBtnSubmit").click(function (event) {
    if (validateCustomer()) {
      $("#frmCustomer").submit();
    } else {
      return false;
